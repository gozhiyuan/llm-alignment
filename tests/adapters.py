...
from cs336_alignment.sq5_hh_dataset import (
    load_hh_dataset,
    get_packed_sft_dataset as _get_packed_sft_dataset,
    iterate_batches as _iterate_batches,
)
from cs336_alignment.sq5_dpo import compute_per_instance_dpo_loss, compute_grpo_microbatch_train_step
...
def run_grpo_microbatch_train_step(
    ...
    """
    return run_grpo_microbatch_train_step(
        policy_log_probs=policy_log_probs,
        response_mask=response_mask,
        gradient_accumulation_steps=gradient_accumulation_steps,
        loss_type=loss_type,
...
def run_load_hh_dataset(root_dir: str):
    """Load and preprocess the Anthropic HH dataset."""
    return load_hh_dataset(root_dir)
